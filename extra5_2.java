...
public class extra5_2 extends GraphicsProgram{
	...
	private static final int DIFF_WINDOWS = 2;
	GLine line;
	public void run(){
		...
		add(window1,  (getWidth() - HOUSE_WIDTH)/2 + (HOUSE_WIDTH - 2 * WINDOWS_WIDTH - DIFF_WINDOWS)/2, (getHeight() - HOUSE_HEIGHT)/2 + DIFF_WINDOWS); 
